...
public class REST {
    ...
    private JSONObject checkStatus(Request req) {
        JSONObject obj = new JSONObject();
        if (proxyNode == null) {
            return setError(1, "There is no proxyNode connected to this API");
        }
    ...
    private JSONObject updateStatus(Request req) {
        JSONObject obj = new JSONObject();
        if (proxyNode == null) {
            return setError(1, "There is no proxyNode connected to this API");
        }
    ...
    private JSONObject setError(int code, String message) {
